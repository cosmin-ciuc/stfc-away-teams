...
export const allOfficers = [
    ...
    new Officer({ name: 'Badgey', rarity: 'Uncommon', traits: ['Deceptive', '', ''] }),
    new Officer({ name: 'Barot', rarity: 'Rare', traits: ['Surveyor', 'Miner', ''] }),
    new Officer({ name: 'Beckett Mariner', rarity: 'Epic', traits: ['Warrior', 'Manipulative', 'Impulsive'] }),
    ...
    new Officer({ name: 'Brad Boimler', rarity: 'Rare', traits: ['Ambitious', 'Reliable', ''] }),
    ...
    new Officer({ name: 'Cath', rarity: 'Rare', traits: ['Ambitious', 'Explorer', ''] }),
    ...
    new Officer({ name: 'Rom', rarity: 'Epic', traits: ['Engineer', 'Dedicated', 'Leader'] }),

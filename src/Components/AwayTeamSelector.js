...
import AwayTeamMission from '../Models/awayTeamMission';
import PropTypes from 'prop-types';

const awayTeamMissions = [
    ...
    new AwayTeamMission({ name: 'Bat\'leth Training', rarity: 'Rare', keyStat: 'Attack', primaryRewards: 'Premium Recruit Tokens', secondaryRewards: '', criticalRewards: 'Moreau/Livis Shards', traits: ['Ruthless', 'Warrior', '', ''] }),
    ...
    new AwayTeamMission({ name: 'Double Agent Interrogation', rarity: 'Rare', keyStat: 'Health', primaryRewards: 'Premium Recruit Tokens', secondaryRewards: 'Service Awards', criticalRewards: 'Moreau/Uhura Shards', traits: ['Empathic', 'Perceptive', 'Security', 'Spy'] }),
